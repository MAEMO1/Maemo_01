...
// Dynamic import for Three.js scene - disable SSR
const HeroScene = dynamic(
  () => import('../three/HeroScene').then(mod => ({ default: mod.HeroScene })),
  { ssr: false }
);
...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-hero-gradient noise-overlay">
      ...
      <div
        className="absolute top-0 right-0 w-full h-full md:w-[60%] lg:w-[55%]"
        style={{
          opacity: 0,
