...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-ink overflow-hidden">
      {/* Floating background elements - matching homepage FloatingCards style */}
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-6 pt-32 pb-16">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <AnimatedSection animation="fade-in-scale">
            ...
            {/* Headline - dramatic like homepage */}
            <h1
      ...
      {/* Pathways Section - Floating card style like homepage */}
        ...
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            <div className="grid md:grid-cols-2 gap-5">
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: 'radial-gradient(circle at 30% 30%, rgba(232, 93, 76, 0.15) 0%, transparent 60%)',
                  }}
                />
            ...
            >
              <p
                className="text-sm"
                style={{ color: 'rgba(232, 93, 76, 0.9)' }}
              >
      ...
      {/* Big Text Divider - like homepage */}
      ...
      {/* Form Section - White section like homepage CTA */}
        ...
        <div className="max-w-2xl mx-auto">
          <AnimatedSection>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {/* Submit Button - matching homepage CTA style */}
              <button
                type="submit"
                ...
                onMouseEnter={(e) => {
                  if (!isSubmitting) e.currentTarget.style.background = '#334155';
                }}
                onMouseLeave={(e) => {
  ...
  return (
    <div>
      <label className="block text-sm font-medium mb-2" style={{ color: '#1e293b' }}>
        {label}
        {labelSuffix && (
          <span className="ml-1" style={{ color: '#94a3b8', fontWeight: 400 }}>
            {labelSuffix}
          </span>
        )}
      </label>
...
// Reusable Chip Button Component
